...
void FurnaceGUI::readConfig(DivConfig& conf, FurnaceGUISettingGroups groups) {
  ...
  if (groups&GUI_SETTINGS_APPEARANCE) {
    ...
    settings.volMacroDisplay=conf.getInt("volMacroDisplay",0);
    if (settings.volMacroDisplay<0 || settings.volMacroDisplay>2) settings.volMacroDisplay=0;
...
void FurnaceGUI::writeConfig(DivConfig& conf, FurnaceGUISettingGroups groups) {
  ...
  if (groups&GUI_SETTINGS_APPEARANCE) {
    ...
    conf.set("volMacroDisplay",settings.volMacroDisplay);
